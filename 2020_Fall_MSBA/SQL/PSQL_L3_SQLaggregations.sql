...
/*8.For each account, determine the average amount of each type of paper they purchased across their orders. Your result should have four columns - one for the account name and one for the average spent on each of the paper types.*/
...
/*.HAVING*/
/*1.ow many of the sales reps have more than 5 accounts that they manage?*/
